...
int main(int argc, char **argv)
{
	...
	//-------- init socket server ------------------
	int iRetSocket = initSocket();
	if (iRetSocket != 0) {
		std::cout << "Failed to init socket server.\n";
		return 1;
	}
	std::cout << "Socket server initialized.\n"; 
	...
	//---------- close socket server
	//acturally never happens, since glutMainLoop never returns

	//iRetSocket = closeSocket();
	//if (iRetSocket != 0) {
	//	std::cout << "Failed to close socket server.\n";
	//	return 1;
	//}
	//std::cout << "Socket server closed.\n";
